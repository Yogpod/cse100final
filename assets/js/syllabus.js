...
(function () {
  ...
  const TOPICS = {
    asymptotic: {
      ...
      part: "part1",
      keyPoints: [
          "Big-O (upper bound): show $\u2203\,c>0,\,n_0$ s.t. $T(n) \le c\,g(n)$ for all $n\ge n_0$.",
          "Omega $\u03a9$ (lower bound): show $\u2203\,c>0,\,n_0$ s.t. $T(n) \ge c\,g(n)$ for all $n\ge n_0$.",
          "Theta $\u0398$ (tight bound): show both $T(n)=O(g(n))$ and $T(n)=\u03a9(g(n))$.",
          ...
          "Useful dominance: $n^a \ll n^b$ for $a<b$; $\log^k n \ll n^\u03b5$ for any $\u03b5>0$.",
          "For sums, the largest-order term dominates: e.g. $n^2 + n\log n = \u0398(n^2)$.",
    ...
    recurrences: {
      ...
      part: "part1",
      keyPoints: [
          "Master theorem (typical form): $T(n)=aT(n/b)+\u0398(n^d)$ with $a\ge1$, $b>1$.",
          "Compute the critical exponent: $n^{\log_b a}$ and compare $n^d$ vs $n^{\log_b a}$.",
          "Case 1 ($a>b^d$): $T(n)=\u0398(n^{\log_b a})$ (leaf-dominated).",
          "Case 2 ($a=b^d$): $T(n)=\u0398(n^d \log n)$ (balanced).",
          "Case 3 ($a<b^d$): $T(n)=\u0398(n^d)$ (root-dominated).",
    ...
    insertion: {
      ...
      keyPoints: [
          ...
          "Worst-case comparisons/shifts: $\u0398(n^2)$ (reverse-sorted).",
          "Best-case: $\u0398(n)$ (already sorted; inner loop does ~0 shifts).",
    ...
    mergesort: {
      ...
      keyPoints: [
          ...
          "Recurrence: $T(n)=2T(n/2)+\u0398(n)$ ⇒ $\u0398(n\log n)$ (all inputs).",
    ...
    quicksort: {
      ...
      keyPoints: [
          ...
          "Expected runtime (random pivot / random input): $\u0398(n\log n)$; worst case: $\u0398(n^2)$.",
          ...
          "Recurrence intuition: work per level is $\u0398(n)$, depth depends on partition balance.",
      ],
      generator: "quicksort",
    },
    radix: {
      ...
      keyPoints: [
          ...
          "For base $k$ and $d$ digits: time $\u0398(d(n+k))$ using counting sort per digit.",
    ...
    kselect: {
      ...
      keyPoints: [
          ...
          "Guarantee: pivot is \"good\" (constant-fraction split) ⇒ worst-case $\u0398(n)$.",
          "Classic recurrence: $T(n)\le T(\lceil n/5\rceil)+T(7n/10)+\u0398(n)$.",
      ],
      generator: "kselect",
    },
    ...
    heaps: {
      ...
      keyPoints: [
          ...
          "Array indexing: 1-based parent=$\u230a i/2\u230b$, left=$2i$, right=$2i+1$ (0-based: parent=$\u230a(i-1)/2\u230b$).",
          "Max-Heapify fixes one violation by bubbling a node down; runs in $\u0398(\log n)$.",
          "Build-Max-Heap: heapify from the last internal node down to the root; total time $\u0398(n)$.",
          "Heapsort: build heap then repeatedly extract max; time $\u0398(n\log n)$, in-place, not stable.",
      ],
      generator: "heaps",
    },
    graphreps: {
      ...
      part: "part3",
      keyPoints: [
          "Adjacency matrix: space $\u0398(V^2)$; edge lookup is O(1).",
          "Adjacency list: space $\u0398(V+E)$; iterating neighbors of $u$ costs $\u0398(\deg(u))$.",
          "Dense graphs (E close to $V^2$) can favor matrices; sparse graphs favor lists.",
          "BFS/DFS on lists run in $\u0398(V+E)$; on matrices they can degrade to $\u0398(V^2)$.",
    ...
    traversals: {
      ...
      keyPoints: [
          ...
          "Both BFS and DFS are $\u0398(V+E)$ with adjacency lists.",
      ],
    ...
    shortestpaths: {
      ...
      keyPoints: [
          ...
          "Dijkstra: requires all edge weights ≥ 0; extract-min repeatedly; once settled, a node's distance is final.",
